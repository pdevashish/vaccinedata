...
$ch = curl_init("https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode=248001&date=$date1");
...
echo "<small> Date: " .$datetime1->format('d-m-Y')."</small>";
