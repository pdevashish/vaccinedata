...
<li class="nav-item"><a href="./static.php" class="btn btn-danger btn-sm" style="margin-left:5px; margin-top:2px;" role="button"><b>Dehradun Vaccination Static</b></a></li>
...
<li class="nav-item"><a href="./rudraprayag.php" class="btn btn-danger btn-sm" style="margin-left:5px; margin-top:2px;" role="button"><b>Rudraprayag</b></a></li>
<li class="nav-item"><a href="./jankari.php" class="btn btn-danger btn-sm" style="margin-left:5px; margin-top:2px;" role="button"><b>सामान्य सवाल? </b></a></li>
</ul>
...
<b>BELOW IS DATA FOR NEXT 7 DAY , ESTIMATE TIME FOR ARRIVAL OF NEW SLOT FOR 
